---
title: "DataExtractor"
description: "A node that extracts structured data from unstructured sources like text or files"
---
...
<Info>
  This node works best when the `schemas` are well-defined, as each schema item
