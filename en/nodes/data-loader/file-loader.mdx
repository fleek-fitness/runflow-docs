---
title: "FileLoader"
description: “A Node that loads files to make them available to Runflow”
---
...
<Info>
  When using the FileLoader, keep in mind that the task might experience delays depending on network conditions and
  server response times, so plan your workflow accordingly.
</Info>
