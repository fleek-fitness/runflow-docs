...
description: "A node that splits text content into individual sentences for sentence-level processing."
---
...
<Info>
  This node is particularly useful when you need to manage or analyze text
  content at the sentence level.
</Info>
