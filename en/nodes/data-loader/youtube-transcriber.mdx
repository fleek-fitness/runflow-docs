...
description: "A node that retrieves and transcribes audio from YouTube videos"
---
...
<Info>
  Enabling `is_advanced` can improve transcription accuracy but may increase
  processing time. Use it for videos requiring precise transcription.
</Info>
